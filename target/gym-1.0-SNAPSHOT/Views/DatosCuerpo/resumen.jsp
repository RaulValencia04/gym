    ...
    type: 'bar',
            ...
            labels: fechas, // Usar las fechas ordenadas
                    ...
                    label: 'IMC',
                            ...
                            backgroundColor: [
                                    'rgba(255, 173, 173, 0.9)', // Un tono de rojo más claro
                                    'rgba(173, 216, 230, 0.9)', // Un tono de azul claro
                                    'rgba(255, 237, 173, 0.9)', // Un tono de amarillo claro
                                    'rgba(173, 216, 230, 0.9)', // Otro tono de azul claro
                                    'rgba(206, 255, 173, 0.9)', // Un tono de verde claro
                                    'rgba(255, 173, 216, 0.9)'   // Un tono de rosa claro
