...
<html lang="en">
    ...
    <body  style="background-image: url('img/fondo1.jpg');padding-bottom: 20px" >
        ...
        <h1 class="" style="padding-top: 150px; background-color: rgba(0, 0, 0, 0.3); color: #f5f5f5; font-size: 50px; text-align: center;">Crear Nuevas Categorias</h1>



        <div class="container mt-5" style="padding-top: 30px">
            <div class="card custom-card" style="background-color: rgba(255, 255, 255, 0.7);">
                <div class="card-body">
