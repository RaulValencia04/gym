...
<html lang="en">
    ...
    <body  style="background-image: url('img/fondo1.jpg'); padding-bottom: 20px" >
        ...
        <style>
            .card:hover {
                box-shadow: 0 0 10px rgba(0, 0, 0, 0.2); /* Cambia el color y la intensidad según tus preferencias */
                transition: box-shadow 0.3s ease-in-out; /* Añade una transición suave */
            }
        </style>


        <h1 class="" style="padding-top: 150px; background-color: rgba(0, 0, 0, 0.3); color: #f5f5f5; font-size: 50px; text-align: center;">Editar Categorias</h1>
                ...
                <div class="card-body">
                    <form action="GuardarCategoriaEditada" method="post">
                        <div class="form-group">
                            <label for="nombreCategoria" style="color: #333; font-weight: bold;">Nombre de la Categoría:</label>
                            <input type="text" class="form-control" id="nombreCategoria" name="nombreCategoria"
                                   value="${listaCategorias.getDescripcion()}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control" id="urlImagen" name="urlImagen"
                                   value="${listaCategorias.getImgUrl()}" required>
                        </div>
