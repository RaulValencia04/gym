                                    ...
                                    <tbody>
                                        <c:forEach var="categoria" items="${listaCategorias}">
                                            <tr>
                                                ...
                                                <td>${categoria.imgUrl}</td>
                                                <td>
                                                    <a href="EditarCategoria?id=${categoria.idCategoria}" class="btn btn-warning">Editar</a>
                                                    <a href="EliminarCategoria?id=${categoria.idCategoria}" class="btn btn-danger">Eliminar</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
